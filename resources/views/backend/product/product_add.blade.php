                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Size En<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_size_en" class="form-control" value="Small,Medium,Large,ExtraLarge" data-role="tagsinput" required=""> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Size Ind<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_size_ind" class="form-control" value="Small,Medium,Large,ExtraLarge" data-role="tagsinput" required=""> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Color Ind<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_color_ind" class="form-control" value="Merah,Hitam,Biru" data-role="tagsinput" required=""> 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Short Description Ind <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="short_descp_ind" id="editor2" rows="10" cols="80" required="">Short Description Ind</textarea>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Long Description En <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="long_descp_en" id="editor3" rows="10" cols="80" required="">Long Description En</textarea>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Long Description Ind <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="long_descp_ind" id="editor4" rows="10" cols="80" required="">Long Description Ind</textarea>
                                            </div>
                                    </div>
                                </div>
