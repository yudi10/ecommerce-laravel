                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Tags Ind<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_tags_ind" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_tags_ind }}"> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Size Ind<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_size_ind" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_size_ind }}"> 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Product Color Ind<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="product_color_ind" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_color_ind }}"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <h5>Selling Price Code<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Short Description En <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="short_descp_en" id="editor1" rows="10" cols="80" required="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Short Description Ind <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="short_descp_ind" id="editor2" rows="10" cols="80" required="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Long Description En <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="long_descp_en" id="editor3" rows="10" cols="80" required="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h5>Long Description Ind <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <textarea name="long_descp_ind" id="editor4" rows="10" cols="80" required="">
                    ...
                    <div class="row rom-sm">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <a href="{{ route('product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete" title="Delete Data">
